...
const model = Schema.Model({
  ...
  habilidades: StringType("El habilidaes debe ser de tipo texto.").isRequired('Es obligatorio escribir el habilidaes.')
});
...
const FormClient = () => {
  ...
  const handleSubmit = async() => {
    ...
    if (!formRef.current.check()) {
      ...
      setLoading(false);
      try {
        const apiRes = await axios.post('https://beauty365api.herokuapp.com/api/v1/empleados/create', 
    ...
    return (
      <>
        ...
        >
          ...
          <TextField name="habilidades" label="Habilidades" />
