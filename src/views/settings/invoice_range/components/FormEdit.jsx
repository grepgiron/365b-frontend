...
const FormNew = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://beauty365api.herokuapp.com/api/v1/rangos/'+id)
  ...
  const handleSubmit = async() => {
    try {
      ...
      const response = await axios.put(
        'https://beauty365api.herokuapp.com/api/v1/rangos/'+id,
        qs.stringify(formValue), {
          ...
          history(`/admin/sar/rangos/show/${response.data._id}`, { state: response.data._id })  
        })
      } catch(error) {
