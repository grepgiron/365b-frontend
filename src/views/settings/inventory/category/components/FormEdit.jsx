  ...
  if (error) {
    ...
    return (
      <>
        ...
        { showErrorEmptyForm ? <ErrMessage mensaje="Error. Hay campos vacíos o datos inválidos." /> : (showError ? <ErrMessage mensaje="Error. No es posible editar el Categoria en estos momentos" />: null) }
      </>
    );
  }
};
