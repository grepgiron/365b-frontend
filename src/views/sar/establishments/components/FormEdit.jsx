...
const FormEstablishment = (props) => {
  ...
  useEffect(() => {
    ...
    axios.get('https://beauty365api.herokuapp.com/api/v1/establecimientos/'+props.id)
      .then((response) => {
        if (response!==error) {
  ...
  const handleSubmit = async() => {
    ...
    if (!formRef.current.check()) {
      ...
      try {
        ...
        const apiRes = await axios.put('https://beauty365api.herokuapp.com/api/v1/establecimientos/'+props.id, qs.stringify(formValue), {
          headers: {
